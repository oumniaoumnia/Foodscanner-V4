...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_INSTRUCTOR = "create table if not exists "
            ...
            + " product_label varchar(30)," + " brands varchar(50)," + " barcode varchar(50)," + " imagestring varchar(50)," + " created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP );";
    ...
    public ArrayList<Product> getData() {
        ...
        if (cursor.moveToFirst()){
            do{
                ...
                list.add(new Product(data,brands,barcode,brands, R.drawable.user));
